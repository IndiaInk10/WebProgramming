...
<script src="${pageContext.request.contextPath}/project/_custom/knu/resource/js/app/app.common4ae3.js?ver=1" defer type="text/javascript" ></script>
<script src="${pageContext.request.contextPath}/project/_custom/knu/resource/js/app/app.adm.curriculum36d9.js" defer type="text/javascript" ></script>
<script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/_share/js/scroll.js"></script>
<script src="${pageContext.request.contextPath}/project/_res/knu/_share/js/cms-commondc50.js?00817" defer type="text/javascript" ></script>
<script src="${pageContext.request.contextPath}/project/_res/knu/aisw/js/cms-common07aa.js?73967" defer type="text/javascript" ></script>
<script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/aisw/js/header.content0b7a.js" ></script>
<script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/aisw/js/greetings.content350a.js?73966" ></script>
<script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/_share/js/footer-default.widget87c5.js?14022" ></script>
<script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/_share/js/gnb-mobile.widget2fae.js?42876" ></script>
<script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/_share/js/pull-down-menu.widget9d66.js?00425" ></script>
...
<footer class="container">
	<div class="row justify-content-between">
		...
		<div class="col-sm-auto">
			<div class="dropdown">
				<button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-offset="0,-750" data-bs-toggle="dropdown" aria-expanded="false">
					교내사이트 바로가기
				</button>
				<ul class="dropdown-menu" style="list-style: disc outside none !important" aria-labelledby="dropdownMenuButton1">
					<div style="font-size:16px">
						<%
							String[] href = {"#", "https://cube.kangwon.ac.kr/portal/index", "https://cms.kangwon.ac.kr/padm/life/general-notice.do?mode=view&articleNo=243895&article.offset=760&articleLimit=10", 
											 ...
											 "https://www.knuh.or.kr/main/main.asp", "#", "https://ile.kangwon.ac.kr:44303/", "https://kculture.kangwon.ac.kr/", "http://knubiornd.com/", "https://kiit.kr/lang_kr.php?pid=index",
							...
							String[] aText = {"KNU 기념품 쇼핑몰", "KNU-큐브 & 메이커스페이스", "강원권역 e-러닝 지원센터", "강원대학교 교수회", "강원대학교 교원양성지원센터",
							...
							if(href.length == aText.length)
							{
								for(int i = 0; i < href.length; i++)
								{
						%>
									<li class="dropdown-item"><span style="padding: 0 3% 0 2%">•</span><a style="text-decoration:none" href=<%=href[i]%>><%=aText[i]%></a></li>
						<%
								}
							}
						%>
						<%-- <li class="dropdown-item"><span style="padding: 0 3% 0 2%">•</span><a style="text-decoration:none" href="#">KNU 기념품 쇼핑몰</a></li>
						...
						<li class="dropdown-item"><span style="padding: 0 3% 0 2%">•</span><a style="text-decoration:none" href="#">강원대학교신문방송사</a></li>
