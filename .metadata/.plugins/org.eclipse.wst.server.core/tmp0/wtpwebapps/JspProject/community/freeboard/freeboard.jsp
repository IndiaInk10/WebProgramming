...
<link href="${pageContext.request.contextPath}/community/freeboard/fboard.css" rel="stylesheet" type="text/css">
...
<%@ include file="dbconn.jsp" %>
  <div class="container pb-4">
    ...
    %>
        <br><br>
        <FORM class="form-inline" method="post" name="msgsearch" action="../community/freeboard/freeboard_search.jsp?table=freeboard">
          <div class="container_div">
            <div class="row form-group">
              ...
              &nbsp;
              <a class="col-auto p-0 me-3" href="#" onClick="check();"><button type="button" class="btn btn-success">검색</button></a>
            </div>
            <br>
            <div align=right><A href="../community/freeboard/freeboard_write.jsp?table=freeboard"><img src="../community/freeboard/image/write.gif" class="img-fluid"></A></div>
          </div>
       </FORM>
    </TABLE>
  </CENTER>
