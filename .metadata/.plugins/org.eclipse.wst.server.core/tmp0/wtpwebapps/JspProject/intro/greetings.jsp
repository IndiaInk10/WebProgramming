            ...
            <div class="content-box">
                <div class="greeting-box">
                    <div class="greeting-top-box" style="background-color: #007BFF; text-align: center; padding: 0 1% 0 1%">
                        <div class="greeting-top-txt-box" style="background-color: #007BFF; text-align: center; padding: 0 1% 0 0">
                            <p class="greeting-p">세계를 향한 꿈을 키우는 첫무대</p>
                            <p class="greeting-p">새롭게 도전하는 강원도의 선도대학</p>
                            <p class="greeting-title">강원대학교 AI소프트웨어학과</p>
                        </div>
                        <div class="greeting-img-box"><img src="${pageContext.request.contextPath}/project/_res/knu/_share/img/contents/img-greeting-type05.jpg" alt=""></div>
                    </div>
                    <div class="greeting-con-box">
                        <div class="greeting-txt-box" style="padding-top: 2%">
                            <p class="strong-p" style="color:red">안녕하세요<br>강원대학교 공학대학 AI소프트웨어학과 홈페이지를 방문해주셔서 감사합니다.</p>
