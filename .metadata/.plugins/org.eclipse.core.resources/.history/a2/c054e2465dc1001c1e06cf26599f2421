...
<div class="container">
    ...
    <div class="content-inner-wrap cms-print">
	    <div class="title" data-cms-content="/aisw/_content/title">
            <div class="page-title"><h3>인사말</h3></div>
		</div>
		<div class="tab"></div>
        ...
        <div class="content" id="cms-content">
            <div class="content-box">
                <div class="greeting-box">
                    <div class="greeting-top-box">
                        <div class="greeting-top-txt-box">
                            <p class="greeting-p">세계를 향한 꿈을 키우는 첫무대<br>새롭게 도전하는 강원도의 선도대학</p>
                    ...
                    <div class="greeting-con-box">
                        <div class="greeting-txt-box">
                            <p class="strong-p">안녕하세요<br>강원대학교 공학대학 AI소프트웨어학과 홈페이지를 방문해주셔서 감사합니다.</p>
