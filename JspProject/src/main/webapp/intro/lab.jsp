...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/aisw/css/lab.content68e6.css?after" />
...
<div class="container">
    ...
    <div class="content-inner-wrap cms-print">
		<div class="title" data-cms-content="/aisw/_content/title">
            <div class="page-title"><h3>실습실소개</h3></div>
		</div>
		<div class="tab"></div>
		<div class="content">
            <div class="content-box">
                <div class="con-box no-pd">
                    <ul class="lab-box row row-cols-2">
                        <li style="text-align:center"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab01.jpg" alt="컴퓨터구조 실습실">
                            <div class="txt-box">
                                <h4 class="pt-2 pb-3 mb-0">컴퓨터구조 실습실</h4>
                        ...
                        <li style="text-align:center"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab02.jpg" alt="컴퓨터응용실습실">
                            <div class="txt-box">
                                <h4 class="pt-2 pb-3 mb-0">컴퓨터응용실습실</h4>
                                <ul style="list-style-type:disc;text-align:left">
                                    <li>위치 : 5공학관 418호</li>
                        ...
                        <li style="text-align:center"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab03.jpg" alt="미디어LAB">
                            <div class="txt-box">
                                <h4 class="pt-2 pb-3 mb-0">미디어LAB</h4>
                                <ul style="list-style-type:disc;text-align:left">
                                    <li>위치 : 5공학관 501호</li>
                        ...
                        <li style="text-align:center"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab04.jpg" alt="멀티미디어실습실">
                            <div class="txt-box">
                                <h4 class="pt-2 pb-3 mb-0">멀티미디어실습실</h4>
                                <ul style="list-style-type:disc;text-align:left">
                                    <li>위치 : 5공학관 502호</li>
                        ...
                        <li style="text-align:center"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab05.jpg" alt="프로그래밍실습실">
                            <div class="txt-box">
                                <h4 class="pt-2 pb-3 mb-0">프로그래밍실습실</h4>
                                <ul style="list-style-type:disc;text-align:left">
                                    <li>위치 : 5공학관 517호</li>
                        ...
                        <li style="text-align:center"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab06.jpg" alt="크리에이터스튜디오">
                            <div class="txt-box">
                                <h4 class="pt-2 pb-3 mb-0">크리에이터스튜디오</h4>
                                <ul style="list-style-type:disc;text-align:left">
                        ...
                        <li id="remain"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab07.jpg" alt="경영과학실험실"></li>
                        <li id="remain"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab08.jpg" alt="공장자동화실험실"></li>
                        <li id="remain"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab09.jpg" alt="생산경영실험실"></li>
                        <li id="remain"><img src="${pageContext.request.contextPath}/project/_res/knu/aisw/img/intro/img-lab10.jpg" alt="인간공학실험실"></li>
                    </ul>
                </div>
            </div>
	    </div>
