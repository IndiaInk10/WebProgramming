...
<head>
    ...
    <link defer rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/_share/css/swiper.min.css?after" />
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/_share/css/main-visual-temp08.widget03b3.css?after">
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/_share/css/announcement-miniboard-template-08-bulletin-board.widget841b.css?after">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/_share/css/announcement-mini-board-template-08-representative.widget1270.css?after">
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/aisw/css/main3d9d.css?after">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/aisw/css/main-content02.content3d9d.css?after">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/project/_res/knu/aisw/css/main-content01.content7204.css?after">
...
<body>
    ...
    <script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/_share/js/swiper.min.js?after"></script>
    ...
    <script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/aisw/js/main-content01.content7204.js?after" ></script>
    ...
    <script defer type="text/javascript" src="${pageContext.request.contextPath}/project/_res/knu/_share/js/main-visual-temp08.widget03b3.js?after"></script>
